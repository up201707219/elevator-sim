...
export const actions = {
    ...
    copyExercise: async ({request, params}) => {
        ...
        try {
            ...
            query = 'insert into question_menu(question_id, id, title, descript, response, parent_id, points) ' +
            'select $1 , (id+100) title, descript, response, (parent_id+100), points from question_menu where question_id = $2 ;';
